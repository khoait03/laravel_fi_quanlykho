...
class PostMetaPolicy
{
    ...
    {
        return $user->can('view_any_post::meta');
    }
    ...
    {
        return $user->can('view_post::meta');
    }
    ...
    {
        return $user->can('create_post::meta');
    }
    ...
    {
        return $user->can('update_post::meta');
    }
    ...
    {
        return $user->can('delete_post::meta');
    }
    ...
    {
        return $user->can('delete_any_post::meta');
    }
